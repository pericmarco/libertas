...
export const PROCESSES: ParticipationProcess[] = [
  ...
  },
  {
    ...
    level: 'Konsultation',
    accent: 'bg-emerald-50 text-emerald-600', emoji: '🚲', image: '/muster/mobilitaet-2035.jpg',
  ...
  },
  {
    ...
    level: 'Mitentscheidung',
    accent: 'bg-purple-50 text-purple-600', emoji: '💶', image: '/muster/buergerbudget-2027.jpg',
  ...
  },
  {
    ...
    level: 'Konsultation',
    accent: 'bg-sky-50 text-sky-600', emoji: '🚉', image: '/muster/bahnhofsvorplatz.jpg',
  ...
  },
  {
    ...
    level: 'Konsultation',
    accent: 'bg-green-50 text-green-600', emoji: '🌳', image: '/muster/mehr-gruen-innenstadt.jpg',
